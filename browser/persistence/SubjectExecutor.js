...
export class SubjectExecutor {
    ...
    broadcastBeforeEventsForAll() {
        ...
        if (this.insertSubjects.length)
            this.insertSubjects.forEach((subject) => {
                var _a;
                return this.queryRunner.broadcaster.broadcastBeforeInsertEvent(result, subject.metadata, (_a = subject.entity) !== null && _a !== void 0 ? _a : subject.createValueSetAndChangeMapsWithoutValues()[0]);
            });
    ...
    broadcastAfterEventsForAll() {
        ...
        if (this.insertSubjects.length)
            this.insertSubjects.forEach((subject) => {
                var _a;
                return this.queryRunner.broadcaster.broadcastAfterInsertEvent(result, subject.metadata, (_a = subject.entity) !== null && _a !== void 0 ? _a : subject.insertedValueSet);
            });
        if (this.updateSubjects.length)
